...
@section('ContentHeader')
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{trans('admin/menu.create')}}</li>
        </ol>
@endsection
@section('content')
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">{{trans('admin/menu.create')}}</h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
    <form method="post" action="{{url('admin/menu')}}"  id="createForm">
        <div class="box-body">
            {!!csrf_field()!!}
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                <label for="name">{{trans('admin/menu.model.name')}}</label>
                <input type="text" name="name" id="name" class="form-control" placeholder="{{trans('admin/menu.model.name')}}">
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" name="icon" id="icon" placeholder="{{trans('admin/menu.model.icon')}}" >
            ...
            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                ...
                <input type="text" name="slug" id="slug" class="form-control" placeholder="{{trans('admin/menu.model.slug')}}">
                @if ($errors->has('slug'))
            ...
            <div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
                ...
                <input type="text" name="url" id="url" class="form-control" placeholder="{{trans('admin/menu.model.url')}}">
                @if ($errors->has('url'))
            ...
            <div class="form-group{{ $errors->has('active') ? ' has-error' : '' }}">
                ...
                <input type="text" name="active" id="active" class="form-control" placeholder="{{trans('admin/menu.model.active')}}">
            ...
            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                <input type="text" name="description" id="description" class="form-control" placeholder="{{trans('admin/menu.model.description')}}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="sort" id="sort" class="form-control" placeholder="{{trans('admin/menu.model.sort')}}">
            </div>
        </div>
        <!-- /.box-body -->

        <div class="box-footer">
            <button type="button" class="btn ladda-button btn-primary createButton">
