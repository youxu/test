...
return [
    ...
    'compose' => [
		'create_success' 	=> '添加组件成功',
		'create_error' 		=> '添加组件失败',
		'edit_success' 		=> '修改组件成功',
		'edit_error' 		=> '修改组件失败',
		'destroy_success' 	=> '删除组件成功',
		'destroy_error' 	=> '删除组件失败',
	],
    'contro' => [
		'create_success' 	=> '添加控制器成功',
		'create_error' 		=> '添加控制器失败',
		'edit_success' 		=> '修改控制器成功',
		'method_edit_success' 		=> '修改方法成功',
		'method_create_success' 		=> '添加方法成功',
		'edit_error' 		=> '修改控制器失败',
		'destroy_success' 	=> '删除控制器成功',
		'destroy_error' 	=> '删除控制器失败',
	],
	'role' => [
